...
public class favouriteCryptoCurrencyAdapter extends RecyclerView.Adapter<favouriteCryptoCurrencyAdapter.CryptoViewHolder> {
    private ArrayList<CryptoCurrencies> cryptoCurrencies;
    private Context context;
    private RecyclerView recyclerView;

    public favouriteCryptoCurrencyAdapter(Context context, ArrayList<CryptoCurrencies> cryptoCurrencies, RecyclerView recyclerView){
    ...
    class CryptoViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(CryptoCurrencies cryptoCurrencies){
            ...
            final boolean[] VisibleRecycler = {false};
